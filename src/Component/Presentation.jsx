...
function Presentation() {
    ...
    <section className='bg-gray-50'>
        <div className='container flex flex-col lg:flex-row items-center gap-20 py-12 px-6 md:px-12 lg:px-16 max-w[1400] mx-auto'>
            {/* left section */}
            ...
            {/* text-black text-3xl md:text-4xl lg:text-5xl font-semibold max-w-md text-center lg:text-start lg:max-0 */}

            {/* right section */}
            <div className='w-full lg:w-1/2 lg:text-left space-y-6'>
                <h1 className='text-black max-w-md mx-auto lg:mx-0 text-3xl md:text-4xl lg:text-5xl font-semibold text-center lg:text-start'>The quickest way to create modern presentation</h1>
                ...
                <button className='bg-indigo-100 text-[#5F62E2] font-semibold px-6 py-3 transition duration-300 rounded-lg flex items-center justify-center gap-2 hover:bg-indigo-200 mx-auto lg:mx-0 '>Explore All 
